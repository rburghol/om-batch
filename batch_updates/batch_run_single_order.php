...
print("   Run ID - " . print_r($run_ids,1) . " \n");
...
//   foreach ( $heap as $thisrec ) {
   while ( count($heap) > 0 ) {
      ...
      if (($operation <> 2) and $resume and checkRunDate($listobject, $recid, $thisid, $cache_date, $startdate, $enddate)) {

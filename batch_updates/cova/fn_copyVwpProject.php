...
// get container for proposed object so that we can store graphs and 
// other such necessries when exploring a withdrawal
$container_template = 323192;
$container = copyModelElement ($container_template);

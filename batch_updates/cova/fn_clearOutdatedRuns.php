...
if (count($argv) < 5) {
   print("Usage: fn_checkTreeRunDate.php elementid runid startdate enddate cache_date [remove_outdated=0] [debug=0]\n");
   die;
}
...
$tree_check = checkTreeRunDate($listobject, $recid, $run_id, $startdate, $enddate, $cache_date, $debug, $remove_outdated);
if ($tree_check == 0) {
   removeRunCache($listobject, $recid, $run_id);
}

print("$tree_check = checkTreeRunDate(listobject, $recid, $run_id, $startdate, $enddate, $cache_date, $debug, $remove_outdated) \n");

...
switch ($mode) {
   ...
   case 1:
      ...
      $listobject->querystring .= " from (select riverseg, contrib_area_sqmi ";
      $listobject->querystring .= "       from sc_cbp53 ";
      $listobject->querystring .= "       group by riverseg, contrib_area_sqmi ";
      $listobject->querystring .= " )as a,  ";
      $listobject->querystring .= "    (select a.riverseg, ";
      ...
      $listobject->querystring .= "     from sc_cbp53 as a, ";
      ...
      $listobject->querystring .= "     where a.riverseg = b.catcode2 ";
      $listobject->querystring .= "     group by a.riverseg ";
      $listobject->querystring .= " ) as b ";
